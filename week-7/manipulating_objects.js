...
What tests did you have trouble passing? What did you do to make it pass? Why did that work?
  None of the tests were particularly hard. Adding attributes is fairly 
  straightforward in Javascript!

How difficult was it to add and delete properties outside of the object itself?
  Not very difficult--the syntax for adding properties is easy, deleting just
  requires reading the documentation.

What did you learn about manipulating objects in this challenge?
  That Javascript excels in this regard in adding and removing attributes.
  However, in the future this may end up being a liability.
